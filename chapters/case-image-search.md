...
* Loss Function: contrastive loss 
  * contrastive loss: 
    ...
    * calculate distance: between pairs -> softmax -> cross entropy <- Labels 
...
- Keep image search architecture as embedding retrieval + ANN index + business re-ranking.
- Use contrastive pretraining and periodic hard-negative mining to maintain retrieval quality.
- Maintain index freshness with incremental updates for new/updated/deleted images.
- Use vector compression (PQ/OPQ) and tiered indexes to manage memory at billion scale.
- Add near-duplicate suppression in the final layer to improve perceived result diversity.
