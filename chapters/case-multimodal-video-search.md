...
- Split into modality-specific encoders (text/video/audio/metadata) and fuse at retrieval + ranking time.
- Use late-fusion in retrieval for robustness, then cross-modal interaction in ranking for precision.
- Precompute video embeddings offline and support incremental near-real-time updates for new uploads.
- Add speech-to-text and OCR pipelines so textual evidence inside video is searchable.
- Apply policy/safety filters before final ranking to avoid surfacing restricted content.

### References
- CLIP (cross-modal representation): https://arxiv.org/abs/2103.00020
- ColBERT late interaction idea (for efficient contextual matching): https://arxiv.org/abs/2004.12832
- Faiss ANN retrieval at scale: https://arxiv.org/abs/2401.08281
