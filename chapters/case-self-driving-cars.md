...
* Instance segmentation 
  * combine obj detection + semantic segmentation -> classify pixels of each instance of an object  
...
- Use strict latency budgets per module (perception, prediction, planning, control) with deterministic fallbacks.
- Prefer multi-sensor fusion with explicit uncertainty estimation; degrade gracefully under sensor failures.
- For 3D perception, modern stacks commonly use lidar-based detectors with BEV representations for speed/accuracy trade-offs.
- Keep simulation, closed-track, and shadow-mode evaluation loops before broad deployment.
- Define safety KPIs beyond model metrics: disengagements, intervention-critical events, and scenario coverage.

## References
- Faster R-CNN: https://arxiv.org/abs/1506.01497
- PointPillars: https://arxiv.org/abs/1812.05784
- CenterPoint: https://openaccess.thecvf.com/content/CVPR2021/html/Yin_Center-Based_3D_Object_Detection_and_Tracking_CVPR_2021_paper.html
