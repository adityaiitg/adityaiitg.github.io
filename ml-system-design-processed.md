...
# 1. The 9-Step ML System Design Formula ([Template](chapter.html?file=mlsd-template)) 
...
- Model selection (MVP)
  ...
  - Decision Factors 
    ...
    - Continual learning  
    - Interpretability 
  - [Popular NN architectures](chapter.html?file=mlsd-modeling-popular-archs)
...
- **[Video/Movie recommendation](chapter.html?file=mlsd-video-recom)**(Netflix, Youtube)
- **[Friends / follower recommendation](chapter.html?file=mlsd-pymk)**(Facebook, Twitter, LinkedIn)
- **[Event recommendation system](chapter.html?file=mlsd-event-recom)** (Eventbrite)
- **[Game recommendation](chapter.html?file=mlsd-game-recom)**
...
### Search systems (retrieval, ranking)
  - **Document search**
    - **[Text query search](chapter.html?file=mlsd-search)** (full text, semantic), 
    - **[Image/Video search](chapter.html?file=mlsd-image-search)**, 
    - **[Multimodal search](chapter.html?file=mlsd-mm-video-search)** (MM Query)
    <!-- - Semantic Search system  -->
### Ranking systems 
- **[Newsfeed system](chapter.html?file=mlsd-newsfeed)** (ranking)  
- **Ads serving system** (retrieval, ranking)
  - **[Ads click prediction](chapter.html?file=mlsd-ads-ranking)** (ranking)
...
- **Self-driving car**
  ...
  - [Pedestrian jaywalking detection](chapter.html?file=mlsd-av)
...
- **Harmful content / Spam detection system**
  - [Multimodal harmful content detection](chapter.html?file=mlsd-harmful-content)  
